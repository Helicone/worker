...
class Params_StableDiffusionV1_4_Sampler(sgqlc.types.Enum):
    __schema__ = worker
    __choices__ = ('ddim', 'k_dpm_2', 'k_dpm_2_ancestral', 'k_euler', 'k_euler_ancestral', 'k_huen', 'k_lms', 'plms')
...
class AudioAsset(sgqlc.types.Input):
    ...
    bytes = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='bytes')
...
class JobResult(sgqlc.types.Input):
    ...
    stable_diffusion_v1_4 = sgqlc.types.Field('JobResultStableDiffusionV1_4', graphql_name='stableDiffusionV1_4')
    unknown_audio_v0 = sgqlc.types.Field('JobResultUnknownAudioV0', graphql_name='unknownAudioV0')


class JobResultStableDiffusionV1_4(sgqlc.types.Input):
    __schema__ = worker
    __field_names__ = ('images',)
    images = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(ImageAsset))), graphql_name='images')


class JobResultUnknownAudioV0(sgqlc.types.Input):
    __schema__ = worker
    __field_names__ = ('audios',)
    audios = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(AudioAsset))), graphql_name='audios')


class JobType(sgqlc.types.Input):
    __schema__ = worker
    __field_names__ = ('stable_diffusion_v1_4', 'unknown_audio_v0', 'custom')
    stable_diffusion_v1_4 = sgqlc.types.Field('JobTypeStableDiffusionV1_4', graphql_name='stableDiffusionV1_4')
    unknown_audio_v0 = sgqlc.types.Field('JobTypeUnknownAudioV0', graphql_name='unknownAudioV0')
...
class JobTypeStableDiffusionV1_4(sgqlc.types.Input):
    ...
    action = sgqlc.types.Field(sgqlc.types.non_null(Params_StableDiffusionV1_4_Action), graphql_name='action')
...
class Params_StableDiffusionV1_4(sgqlc.types.Input):
    __schema__ = worker
    __field_names__ = ('action', 'prompt', 'width', 'height', 'cfg_scale', 'steps', 'n_samples', 'sampler', 'seed', 'input_image')
    action = sgqlc.types.Field(sgqlc.types.non_null(Params_StableDiffusionV1_4_Action), graphql_name='action')
    ...
    sampler = sgqlc.types.Field(Params_StableDiffusionV1_4_Sampler, graphql_name='sampler')
...
class PromptRequestBody(sgqlc.types.Input):
    __schema__ = worker
    __field_names__ = ('stable_diffusion_v1_4', 'unknown_audio_v0', 'custom')
    stable_diffusion_v1_4 = sgqlc.types.Field(Params_StableDiffusionV1_4, graphql_name='stableDiffusionV1_4')
    unknown_audio_v0 = sgqlc.types.Field(Params_UnknownAudioV0, graphql_name='unknownAudioV0')
...
class ApiKey(sgqlc.types.Type):
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    associated_user = sgqlc.types.Field(sgqlc.types.non_null('User'), graphql_name='associatedUser')
...
class PromptRequest(sgqlc.types.Type):
    __schema__ = worker
    __field_names__ = ('_user_id', 'id', 'prompt', 'params', 'result', 'user', 'model_type', 'status', 'created_at')
    _user_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='_userId')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    prompt = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='prompt')
    ...
    model_type = sgqlc.types.Field(sgqlc.types.non_null(ModelType), graphql_name='modelType')
    status = sgqlc.types.Field(sgqlc.types.non_null(PromptRequestStatus), graphql_name='status')
...
class Query(sgqlc.types.Type):
    ...
    jobs = sgqlc.types.Field(sgqlc.types.list_of(PromptRequest), graphql_name='jobs')
    user = sgqlc.types.Field('User', graphql_name='user')
...
class ResultParams_StableDiffusionV1_4(sgqlc.types.Type):
    ...
    width = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='width')
    height = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='height')
    cfg_scale = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='cfgScale')
    steps = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='steps')
    n_samples = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='nSamples')
    sampler = sgqlc.types.Field(sgqlc.types.non_null(Params_StableDiffusionV1_4_Sampler), graphql_name='sampler')
...
class Result_StableDiffusionV1_4(sgqlc.types.Type):
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    images = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Image))), graphql_name='images')
    request = sgqlc.types.Field(sgqlc.types.non_null(PromptRequest), graphql_name='request')
...
class Result_UnknownAudioV0(sgqlc.types.Type):
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    audio_files = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Audio))), graphql_name='audioFiles')
    request = sgqlc.types.Field(sgqlc.types.non_null(PromptRequest), graphql_name='request')
...
class User(sgqlc.types.Type):
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    api_keys = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(ApiKey)), graphql_name='apiKeys')
    requested_prompts = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(PromptRequest)), graphql_name='requestedPrompts')
...
class RequestModelParams(sgqlc.types.Union):
    __schema__ = worker
    __types__ = (ResultParams_StableDiffusionV1_4, ResultParams_UnknownAudioV0, ResultParams_Custom)
